...
file_name = '/scratch/gpfs/MUELLER/ltt/Hydrogen/2D/plt/no_amr/plt_h02408' 
f_1 = yt.load(file_name)

file_name_1 = '/scratch/gpfs/MUELLER/ltt/Hydrogen/2D/plt/amr1/plt_h02521'
file_name_2 = '/scratch/gpfs/MUELLER/ltt/Hydrogen/2D/plt/amr2/plt_h02007'
file_name_3 = '/scratch/gpfs/MUELLER/ltt/Hydrogen/2D/plt/amr3/plt_h01978'
...
ax = plt.figure()
plt.plot(x_arr,pres_1[:,2,0]*10**(-1), label="No AMR", color=colors[0])
plt.plot(x_arr1,pres_amr1[:,4,0]*10**(-1), label="AMR 1", color=colors[1])
plt.plot(x_arr2,pres_amr2[:,6,0]*10**(-1), label="AMR 2", color=colors[2])
plt.plot(x_arr3,pres_amr3[:,8,0]*10**(-1), label="AMR 3", color=colors[3])
plt.grid()
plt.legend()
plt.xlabel("X (cm)")
